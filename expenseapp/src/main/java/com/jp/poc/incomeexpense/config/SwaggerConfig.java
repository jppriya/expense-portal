package com.jp.poc.incomeexpense.config;
...
public class SwaggerConfig {
	...
	public static final ApiInfo DEFAULT_APIINFO = new ApiInfo("Api Documentation", "Api Description", "1.0", "urn:tos",
			"JP", "Apache 2.0", "http://www.apache.org/licenses/LICENSE-2.0");

	@Bean
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(DEFAULT_APIINFO).select().apis(regex("/")).build();
